...
<section class="wrapper fx fx-d-row fx-col fx-jcc fx-aife g-30 pb-25">
    <div class="fx-d fx-d-row pt-30 g-30 fx-d-aife pb-25">
        ...
        <h1 class="col-d-60 t-1 t-center t-neue t-regular">Transforme o currículo a partir da computação</h1>  
    </div>
...
<section class="wrapper-home home-imagem fx fx-row fx-jcc pb-35">
    <div class="fx fx-d-row fx-col col-d-40 fx-aic t-center p-25 g-d-30">
        <img class="col-d-30 pb-10" src="<?php echo get_template_directory_uri(); ?>/assets/imgs/home_icon_1.svg" alt="icon 1">
        <div class="col-d-60">
            <h2 class="t-4 t-bold p-10 t-neue"><?php echo get_field( 'titulo_paragrafo_icone_1' ); ?></h2>
    ...
    <div class="fx fx-d-row fx-col col-d-40 fx-aic t-center p-25 g-d-30">
        ...
        <div class="col-d-60">
            <h2 class="t-4 t-bold p-10 t-neue"><?php echo get_field( 'titulo_paragrafo_icone_2' ); ?></h2>
    ...
    <div class="fx fx-d-row fx-col col-d-40 fx-aic t-center p-25 g-d-30">
        ...
        <div class="col-d-60">
            <h2 class="t-4 t-bold p-10 t-neue"><?php echo get_field( 'titulo_paragrafo_icone_3' ); ?></h2>
    ...
    <div class="fx fx-d-row fx-col col-d-40 fx-aic t-center p-25 g-d-30">
        ...
        <div class="col-d-60">
            <h2 class="t-4 t-bold p-10 t-neue"><?php echo get_field( 'titulo_paragrafo_icone_4' ); ?></h2>
            <h3 class="t-4"><?php echo get_field( 'paragrafo_icone_4' ); ?></h3>
        </div>
    </div>
</section>

<section class="wrapper-home fx fx-row links-home g-50 pb-50 fx-jcc">
